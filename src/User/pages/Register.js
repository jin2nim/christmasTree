...
//     const newUser = { id: newId, ...formData, admin: false };
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost/Christmas_final/api/Register.php", {
        method: "POST",
        headers: {
      ...
      const text = await response.text(); // 응답 텍스트 가져오기
      console.log("Raw Response:", text); // 원본 응답 확인
